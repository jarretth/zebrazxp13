...
func ZBRGetHandle(drvName string) (success SuccessReturn, handle Handle, prn_type PrinterType, err uint) {
...
func ZBRPRNEjectCard(handle Handle, prn_type PrinterType) (success SuccessReturn, err uint) {
