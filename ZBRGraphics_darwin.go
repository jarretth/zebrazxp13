...
func ZBRGDIIsPrinterReady(strPrinterName string) (ret SuccessReturn,err uint) { panic("ZBRGDIIsPrinterReady Cannot be called on a non-windows platform"); return 0,0 }
...
func ZBRGDIInitGraphics(strPrinterName string) (ret SuccessReturn, handle Handle, err uint) { panic("ZBRGDIInitGraphics Cannot be called on a non-windows platform"); return 0,0,0 }
...
func ZBRGDICloseGraphics(handle Handle) (ret SuccessReturn, err uint){ panic("ZBRGDICloseGraphics Cannot be called on a non-windows platform"); return 0,0 }
func ZBRGDIClearGraphics() (ret SuccessReturn, err uint) { panic("ZBRGDIClearGraphics Cannot be called on a non-windows platform"); return 0,0 }
...
func ZBRGDIPrintGraphics(handle Handle) (ret SuccessReturn, err uint) { panic("ZBRGDIPrintGraphics Cannot be called on a non-windows platform"); return 0,0 }
...
func ZBRGDIDrawText(x uint, y uint, text string, font string, fontsize uint, fontstyle TextFontStyle, color uint32) (ret SuccessReturn, err uint) { panic("ZBRGDIDrawText Cannot be called on a non-windows platform"); return 0,0 }
func ZBRGDIDrawTextEx() (ret SuccessReturn) { panic("ZBRGDIDrawTextEx Cannot be called on a non-windows platform"); return 0 }
func ZBRGDIDrawTextUnicode(x uint, y uint, text string, font string, fontsize uint, fontstyle TextFontStyle, color uint32) (ret SuccessReturn, err uint) { panic("ZBRGDIDrawTextUnicode Cannot be called on a non-windows platform"); return 0,0 }
...
func ZBRGDIDrawTextRect(x uint, y uint, width uint, height uint, alignment TextAlignment, text string, font string, fontsize uint, fontstyle TextFontStyle, color uint32) (ret SuccessReturn, err uint) { panic("ZBRGDIDrawTextRect Cannot be called on a non-windows platform"); return 0,0 }
...
func ZBRGDIDrawLine(x1 uint, y1 uint, x2 uint, y2 uint, color uint32, thickness float32) (ret SuccessReturn, err uint) { panic("ZBRGDIDrawLine Cannot be called on a non-windows platform"); return 0,0 }
...
func ZBRGDIDrawRectangle(x uint, y uint, width uint, height uint, thickness float32, color uint32) (ret SuccessReturn, err uint) { panic("ZBRGDIDrawRectangle Cannot be called on a non-windows platform"); return 0,0 }
func ZBRGDIDrawEllipse(x uint, y uint, width uint, height uint, thickness float32, color uint32) (ret SuccessReturn, err uint) { panic("ZBRGDIDrawEllipse Cannot be called on a non-windows platform"); return 0,0 }
func ZBRGDIDrawBarCode(x uint, y uint, rotation BarCodeRotation, barcodetype BarCodeType, barwidthratio BarCodeWidth, barcodemultiplier uint, barcodeheight uint, textunder BarCodeTextUnder, barcodedata string) (ret SuccessReturn,err uint) { panic("ZBRGDIDrawBarCode Cannot be called on a non-windows platform"); return 0,0 }
